                ...
                <TABLE cellSpacing=0 cellPadding=3 width=165 align=center border=0>
                    ...
                    <TR>
                        <TD class=mainMenu onClick="MenuDisplay('table_6');"><SPAN
                                class=span id=table_6Span>＋</SPAN>用户管理
                        </TD>
                    </TR>
                    <TR>
                        <TD>
                            <TABLE id=table_6 style="DISPLAY: none" cellSpacing=0
                                ...
                                <TBODY>
                                <TR>
                                    <TD class=menuSmall><A class=style2 href="jsp/user/add.jsp"
                                                           target=main>－添加用户</A></TD>
                                </TR>
                                <TR>
                                    <TD class=menuSmall><A class=style2 href="jsp/user/edit.jsp"
                                                           target=main>－修改用户</A></TD>
                                </TR>
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath }/user/list.action?currentPage=1"
                                                           target=main>－用户列表</A></TD>
                                </TR>
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath }/user/exit.action"
                                                           target=main>－退出</A></TD>
                                </TR>
                                </TBODY>
                            </TABLE>
                    ...
                    <TR>
                        <TD class=mainMenu onClick="MenuDisplay('table_1');"><SPAN
                                class=span id=table_1Span>＋</SPAN>项目管理
                        </TD>
                    </TR>
                    <TR>
                        <TD>
                            <TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
                                ...
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath }/jsp/project/add.jsp"
                                                           target=main>－新增项目</A></TD>
                                </TR>
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath }/project/list.action?currentPage=1"
